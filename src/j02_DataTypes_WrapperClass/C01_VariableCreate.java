...
public class C01_VariableCreate {
    public static void main(String[] args) {
        System.out.println("Merhaba ben abdülaziz");//buraya yazılan yazı çalışmaz
        /*bu satır
        busatır
        bu satır
...
//TASk- tamsayı ve ondalıklı sayı tanımlayıp toplam print ediniz
     ...
     //   TASK- tamsayı ve char data type iki veriable tanımlayıp toplam print ediniz
        ...
        int s=33;
        double mn=14.53;
        System.out.println(s+mn); //47.53--> 33.0+14.53
        ...
        System.out.println("adınız = abdülaziz soyadınız = gündüz ");
